...
class RecipeCard extends HTMLElement {
  ...
  * {
  ...
  set data(data) {
    ...
    recipeImage.src = data.imgSrc;
    recipeImage.alt = data.imgAlt;
    article.append(recipeImage);
    ...
    let numberRatings = document.createElement("span");
    numberRatings.innerHTML = `(${data.numRatings})`;
    rating.appendChild(rate);
    rating.appendChild(ratingImg);
    rating.appendChild(numberRatings);
